...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/layanan-salin-normal.css') ?>">
...
<body>
    ...
    <section class="section-deskripsi py-5">
        ...
        <img src="<?= base_url('assets/images/detail_layanan/persalinan-normal.jpg') ?>" class="card-img" alt="Perawatan Bayi" style="max-width: 250px;">
            <div>
